 ...
 * @author senai
 */
public class StudantRegister extends javax.swing.JFrame {

    /**
     * Creates new form StudantRegister
     */
    public StudantRegister() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(lbEmail.getText().isEmpty() || lbCity.getText().isEmpty() || lbName.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Preencha todos os campos");
        } else {
            User user = new User();
            user.setStudantName(lbName.getText());
            user.setStudantPhone(lbPhone.getText());
            user.setStudantEmail(lbEmail.getText());
            user.setStudantCity(lbCity.getText());
            user.setStudantState((String) cbState.getSelectedItem());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudantRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudantRegister().setVisible(true);
            }
        });
    }
